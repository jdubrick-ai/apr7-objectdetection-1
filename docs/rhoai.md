...
3) Access the `workbench` named `apr7-objectdetection-1-notebook`.
...
5) In the terminal, run `cd apr7-objectdetection-1` to navigate to your sample app's directory.
